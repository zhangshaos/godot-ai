...
- Agent workflow for first-class MCP tools, with the one-shot CLI as a fallback when a host lacks direct bindings: [docs/agent-cli-workflow.md](docs/agent-cli-workflow.md).
